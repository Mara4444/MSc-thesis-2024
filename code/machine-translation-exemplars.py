...
##### available languages #####
# nllb_lang = ["ace_Arab", "ace_Latn", "acm_Arab", "acq_Arab", "aeb_Arab", "afr_Latn", "ajp_Arab",
...
# languages = ["afr_Latn","arb_Arab","ban_Latn","bel_Cyrl","bod_Tibt", "bos_Latn","bul_Cyrl", "ces_Latn", "cat_Latn","dan_Latn","ell_Grek","est_Latn", "fin_Latn", "hat_Latn", "heb_Hebr","hin_Deva","hun_Latn", "hye_Armn", 
# "ind_Latn", "ita_Latn","jav_Latn", "khm_Khmr","kor_Hang", "lao_Laoo","mai_Deva", "mar_Deva", "mni_Beng","mya_Mymr", "nno_Latn", "nld_Latn", "npi_Deva","pol_Latn","por_Latn", "slk_Latn","quy_Latn","ron_Latn", "rus_Cyrl", 
# "slv_Latn", "srp_Cyrl", "swe_Latn", "tam_Taml", "tgl_Latn","tur_Latn","vie_Latn" , 'yue_Hant', "zsm_Latn","zul_Latn"]
llama = ['bul_Cyrl','cat_Latn','ces_Latn','dan_Latn','fin_Latn','hrv_Latn','hun_Latn','ind_Latn','ita_Latn','kor_Hang','nld_Latn','nno_Latn','pol_Latn','por_Latn','ron_Latn','slv_Latn','srp_Cyrl','swe_Latn','ukr_Cyrl','vie_Latn']


translate_exemplars(get_dataset("mgsm","en"),llama,model,tokenizer)
